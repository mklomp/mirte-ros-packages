...
std::vector<std::shared_ptr<Hiwonder_bus_module>> Hiwonder_bus_module::get_hiwonder_modules(
...
void Hiwonder_bus_module::position_cb(std::vector<tmx_cpp::HiwonderServo_module::Servo_pos> pos)
{
  for (auto p : pos) {
