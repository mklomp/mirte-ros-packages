...
public:
  ...
  DeviceData(std::shared_ptr<Parser> parser, std::shared_ptr<Mirte_Board> board,
             std::string name, std::string device_type,
  ...
  /// @brief Get the device class of this type. So 'distance' for sonars and
