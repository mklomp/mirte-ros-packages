...
// TODO: Maybe add (optional) calibration data, since this sensor has a
...
ADXL345Data::insert_default_frame_id(
...
std::set<std::string> &
ADXL345Data::insert_default_frame_id(std::set<std::string> &unused_keys) {
