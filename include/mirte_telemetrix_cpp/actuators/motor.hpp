...
public:
  Motor(
    NodeData node_data, std::shared_ptr<Motor_data> motor_data, std::string name,
...
{
public:
  PPMotor(NodeData node_data, std::shared_ptr<Motor_data> motor_data, std::string name);
...
{
public:
  DPMotor(NodeData node_data, std::shared_ptr<Motor_data> motor_data, std::string name);
  void set_speed(int speed);
  pin_t dir_pin;
  pin_t pwm_pin;
};
...
{
public:
  DDPMotor(NodeData node_data, std::shared_ptr<Motor_data> motor_data, std::string name);
  void set_speed(int speed);
  pin_t A_pin;
  pin_t B_pin;
  pin_t pwm_pin;
